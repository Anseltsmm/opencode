...
// AZKIATheme implements the Theme interface with AZKIA brand colors.
// It provides both dark and light variants.
type AZKIATheme struct {
	BaseTheme
}

// NewAZKIATheme creates a new instance of the AZKIA theme.
func NewAZKIATheme() *AZKIATheme {
	// AZKIA color palette
	// Dark mode colors
...
func init() {
	// Register the AZKIA theme with the theme manager
	RegisterTheme("azkia", NewAZKIATheme())
}
