...
func (m InitDialogCmp) View() string {
	...
	explanation := baseStyle.
		...
		Width(maxWidth).
		Padding(0, 1).
		Render("Initialization generates a new AZKIA.md file that contains information about your codebase, this file serves as memory for each project, you can freely add to it to help the agents be better at their job.")
